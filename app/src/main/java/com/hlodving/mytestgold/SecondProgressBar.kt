...
enum class BonusStage(val number: Int, val max: Int, val bonusTimeMillis: Long) {
    ...
    STAGE_1(1, 300,  1 * 1 * 1 * 20_000L),
    STAGE_2(2, 300, 1 * 1 * 1 * 20_000L),
    STAGE_3(3, 300, 1 * 1 * 1 * 20_000L),
    STAGE_4(4, 300, 1 * 1 * 1 * 20_000L),
    STAGE_5(5, 300, 1 * 1 * 1 * 20_000L),
    STAGE_6(6, 300, 1 * 1 * 1 * 20_000L),
